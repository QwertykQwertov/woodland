...
$sql = "SELECT * FROM products_stands";
  ...
  <div class="ki-product-card-wrapper d-flex justify-content-around">
    ...
    <?php foreach ($products as $product): ?>
      <div class="ki-product-card text-center">
        <a href="<?= '/catalog/stands_loft/product?id=' . $product['id'] ?>" class="ki-product-card-link">
          <div class="ki-card-image-wrapper">
            <img class="ki-card-image" src=<?= '/assets/images/catalog/stands_loft/' . $product['image'] ?> alt=<?= $product['name'] ?>>
          </div>
