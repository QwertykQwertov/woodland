    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5">
      ...
      <div class="col mb-3">
        ...
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light">г. Лыткарино</a></li>
          <li class="nav-item mb-2"><a href="tel:+79017959902" class="nav-link p-0 text-light">+7 (901) 795-99-02</a></li>
          <li class="nav-item mb-2"><a href="/contacts/" class="nav-link p-0 text-light">mail@mail.ru</a></li>
